...
$lang = array_merge($lang,array(
	"ACCOUNT_SPECIFY_email" 		=> "Please enter your email",
	...
	"ACCOUNT_USER_OR_EMAIL_INVALID"		=> "email or email address is invalid",
	...
	"ACCOUNT_USER_CHAR_LIMIT"		=> "Your email must be between %m1% and %m2% characters in length",
	...
	"ACCOUNT_USER_INVALID_CHARACTERS"	=> "email can only include alpha-numeric characters",
